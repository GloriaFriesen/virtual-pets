...
public class WaterMonsterTest {
  ...
  @Test
  public void waterMonster_instantiatesWithHalfSleepLevel() {
    WaterMonster testWaterMonster = new WaterMonster("Bubbles", 1);
  ...
  @Test
  public void isAlive_recognizesWaterMonsterIsDeadWhenLevelsReachMin_false() {
    WaterMonster testWaterMonster = new WaterMonster("Bubbles", 1);
  ...
  @Test (expected = UnsupportedOperationException.class)
  public void sleep_throwsExceptionIfSleepIsAtMaxValue() {
    WaterMonster testWaterMonster = new WaterMonster("Bubbles", 1);
  ...
  @Test
  public void save_recordsTimeOfCreationInDatebase() {
    WaterMonster testWaterMonster = new WaterMonster("Bubbles", 1);
    testWaterMonster.save();
  ...
  @Test
  public void play_recordsTimeLastPalyedInDatabase() {
    WaterMonster testWaterMonster = new WaterMonster("Bubbles", 1);
    testWaterMonster.save();
    testWaterMonster.play();
  ...
  @Test
  public void time_executesDepleteLevelsMethod() {
    WaterMonster testWaterMonster = new WaterMonster("Bubbles", 1);
